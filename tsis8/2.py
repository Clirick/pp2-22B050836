...
class Food: 
    ...
    def generate_new(self, snake_body):
        ...
        #checks if food fell on snakes body
...
def draw_grid():
    ...
    #draw borders
    pygame.draw.line(SCREEN, WHITE, start_pos=(0, HEIGHT-1), end_pos=(WIDTH-1, HEIGHT-1), width=1)  
    pygame.draw.line(SCREEN, WHITE, start_pos=(0, 0), end_pos=(0, HEIGHT), width=1)   
    pygame.draw.line(SCREEN, WHITE, start_pos=(WIDTH-1, 0), end_pos=(WIDTH-1, HEIGHT-1), width=1)   
    pygame.draw.line(SCREEN, WHITE, start_pos=(0, 0), end_pos=(WIDTH, 0), width=1)    
...
def main():
    ...
    while running:
        ...
        #snake can go backwards if length = 1
