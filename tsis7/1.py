...
screen = pygame.display.set_mode((790, 820))
clock = pygame.time.Clock()
clock60 = dict(zip(range(60), range(0, 360, 6)))
font = pygame.font.SysFont('Arial', 36)
bg = pygame.image.load('main-clock.jfif').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load("left-hand.jfif")
left_rect = image_left.get_rect(bottomleft=(415, 565))
image_right = pygame.image.load('right-hand.jfif')
